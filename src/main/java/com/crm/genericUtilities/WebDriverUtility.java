...
public class WebDriverUtility 
{
	...
	/**
	 * this methhod willwait till the alert msg to be visible
	 * @param driver
	 */
	...
	/**
	 * this method is used to move to active element cursor
	 */
	public void moveToActiveElement(WebDriver driver)
	{
